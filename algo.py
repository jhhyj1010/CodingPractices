...
print("unfoldCalculation for a function recursively: ", myReduceRight(unfoldCalculation, "accm", llToArray(my_ll)))
print("------------------------------------------------------------------------------------")
print("xTimesTwoPlusY after recursion: ", myReduceRight(xTimesTwoPlusY, 0, llToArray(my_ll)))
print("------------------------------------------------------------------------------------")
